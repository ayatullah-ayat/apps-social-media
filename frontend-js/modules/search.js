...
export default class Search {
    ...
    events() {
        ...
        this.closeLiveSearch.addEventListener('click', (e) => {this.closeSearchOverlay()})
    ...
    keyPressHandler() {
      ...
      if(value == "") {
        clearInterval(this.typingWaitTimer)
        this.hideLoaderIcon()
    ...
    sendRequest() {
      ...
      .then((resData) =>{
        this.renderResultsHTML(resData.data)
      }).catch(() => {
    ...
    renderResultsHTML(posts) {
      if(posts.length){
        ...
        this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">No Results found what you are searching</p>`
      }
      this.hideLoaderIcon()
